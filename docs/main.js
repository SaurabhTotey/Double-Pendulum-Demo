...
u.b.lineTo(t.a,t.b)}}
L.cb.prototype={
ao:function(a0,a1){var u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a=this
if(a.x)return
u=a1*a.d
a.y+=u
t=a.a
...
n=o.c
m=a.e
o=Math.sin(a.a.x-2*o.x)
l=Math.sin(a.a.x-a.b.x)
k=a.b
j=k.c
k=Math.pow(k.y,2)
i=a.b.b
...
g=a.a
f=g.b
g=Math.cos(g.x-a.b.x)
e=a.a
d=e.b
c=e.c
b=a.b
t.z=(-q*(r+s)*p-n*m*o-2*l*j*(k*i+h*f*g))/(d*(r+c-b.c*Math.cos(2*(e.x-b.x))))
b=a.b
e=Math.sin(a.a.x-b.x)
c=Math.pow(a.a.y,2)
d=a.a
g=d.b
f=a.e
...
k=i.b
j=i.c
i=Math.cos(a.a.x-i.x)
l=a.b
o=l.b
m=a.a
b.z=2*e*(c*g*r+f*r*d+h*k*j*i)/(o*(r+m.c-l.c*Math.cos(2*(m.x-l.x))))
l=a.a
l.y=l.y+l.z*u
m=a.b
o=m.y+m.z*u
